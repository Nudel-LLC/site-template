...
describe("sanitizeCmsHtml", () => {
  ...
  describe("リンク", () => {
    it("https リンクが許可される", () => {
      const input = '<a href="https://example.co.jp">サイト</a>';
      expect(sanitizeCmsHtml(input)).toContain('href="https://example.co.jp"');
    });
    ...
    it("mailto リンクが許可される", () => {
      const input = '<a href="mailto:info@example.co.jp">メール</a>';
      expect(sanitizeCmsHtml(input)).toContain('href="mailto:info@example.co.jp"');
    });
